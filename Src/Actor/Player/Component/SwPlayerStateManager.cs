...
public class SwPlayerStateManager
{
    ...
    private readonly SwStateMachine<SwPlayer, SwState> StateMachine;
    ...
    public SwPlayerStateManager(SwPlayer parent)
    {
		...
		StateMachine.AddState(new SwPlayerStateSlingCharging(Parent));
		StateMachine.AddState(new SwPlayerStateSlingCharged(Parent));
